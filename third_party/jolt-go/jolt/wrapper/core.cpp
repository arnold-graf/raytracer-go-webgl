...
int JoltInit()
{
	...
	// Large scenes (office-sunset mesh terrain + compounds) need more scratch
	// than the default 10 MB during bulk collider construction.
	gTempAllocator = std::make_unique<TempAllocatorImpl>(512 * 1024 * 1024);
