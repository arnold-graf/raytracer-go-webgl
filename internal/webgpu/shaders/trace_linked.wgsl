...
// modules-sha256: 5b070779a53dcb918bb4aaabe24ab0b5f330c63d031e251e3a2ec9397b0fbb76
...
@group(0) @binding(24) var<storage, read> flame_particles: array<FlameParticle>;

const MAT_EMIT: u32 = 5u; // scene.MatEmit

// FlameParticle mirrors GPUFlameParticle in flame.go (std430, 32-byte stride).
struct FlameParticle {
  pos: vec4<f32>, // xyz, radius (0 = inactive)
  color: vec4<f32>, // linear HDR rgb
}
...
@group(0) @binding(26) var<storage, read_write> aa_hits: array<u32>;
...
@group(0) @binding(25) var<storage, read_write> hdr_pixels: array<vec4<f32>>;
